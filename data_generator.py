...
# output_location_root = '/home/phloxblog/Downloads/Revolve_Solutions_Python_Assignment/python_aasisgnment/input_data/starter'
# start_datetime = datetime(2019, 3, 1, 23, 59, 59)
# end_datetime = datetime(2019, 5, 1, 23, 59, 59)
# x = open_transaction_sinks(output_location_root, start_datetime, end_datetime)
# print(x)

# generate_basket(products, product_id_lookup, cats)